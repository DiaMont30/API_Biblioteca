...
public record EditoraRequestDTO(
                ...
                @NotBlank(message = "Não é possível cadastrar uma editora sem informar o estado") @Schema(description = "Estado onde a editora está localizada", example = "SP", requiredMode = Schema.RequiredMode.REQUIRED) String estado
