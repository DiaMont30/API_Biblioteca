...
public record GeneroRequestDTO(
        ...
        @NotNull(message = "A sigla do gênero é obrigatória e não pode ser vazio") @Schema(description = "Sigla do gênero literário", example = "FIC", requiredMode = Schema.RequiredMode.REQUIRED) SiglaGenero sigla) {
